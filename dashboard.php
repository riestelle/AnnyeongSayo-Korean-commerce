...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .items-grid::-webkit-scrollbar       { height: 4px; }
    .items-grid::-webkit-scrollbar-track { background: var(--surface-container); }
    .items-grid::-webkit-scrollbar-thumb { background: #000; }
    ...
    .dropdown-user-info {
      ...
      background-image: radial-gradient(#00000018 1px, transparent 0);
...
<main>
  ...
  <div class="main-left">
    ...
    <section class="revenue-section kinetic-shadow">
      ...
      <div class="revenue-header">
        ...
        <div style="text-align:right;">
          <div class="revenue-amount">&#x20A9;24,500,000</div><!-- TODO: replace with <?//php echo $total_revenue; ?> -->
          <div class="revenue-badge">
            <span class="material-symbols-outlined">trending_up</span> +12.4%<!-- TODO: replace with <?//php echo $revenue_growth; ?>% -->
          </div>
        </div>
      </div>
    ...
    <section class="items-section kinetic-shadow">
      ...
      <div class="items-grid"><!-- TODO: replace item cards with <?//php foreach($top_products as $product): ?> loop -->
        <!-- Item 1 -->
        <div class="item-card">
        ...
        <div class="item-card">
          <div class="item-img-wrap">
            <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuCdazpm1JfEZ4ycIn7NpiJWBNGAbJYNZrGj8WikYjr-NhsB83qbqupTgNxI7WjGG2i0edqaBUdkDGySm5d3yc8u2tNxch6sBLk5Vpx4nJgo_IlhbgWErhQFo9h8mlYaDMaU3BXWV3N7Km1G4Vn2SryiG1XrYWCXjWRziE0PmWzatZkjSdhPCYWce-DcpECwaqoH306CSt6KtXtyvoWa16xg3MBmftuiruyhLDHnIKG6hyCu_QCcSmhBUSisXKlh3OBwN8CzEVU9sCXQ" alt="brightly colored designer stickers"/>
    ...
    <section class="customers-section kinetic-shadow">
      ...
      <div class="customer-list"><!-- TODO: replace rows with <?//php foreach($top_customers as $customer): ?> loop -->
        <div class="customer-row active">
          <div class="customer-info">
            <span class="customer-id">#ID-8821</span><!-- TODO: <?//php echo $customer['user_id']; ?> -->
            <span class="customer-name">Alex Kim</span><!-- TODO: <?//php echo $customer['username']; ?> -->
          </div>
          <span class="customer-amount">&#x20A9;4,250,000</span><!-- TODO: <?//php echo $customer['total_spent']; ?> -->
        </div>
    ...
    <div class="metrics">
      <div class="metric-card teal-card kinetic-shadow">
        <div class="metric-inner">
          ...
          <div class="metric-value neon-stroke">158</div><!-- TODO: replace with <?//php echo $total_orders; ?> -->
      ...
      <div class="metric-card yellow-card kinetic-shadow">
        ...
        <div class="metric-value neon-stroke">24</div><!-- TODO: replace with <?//php echo $total_users; ?> -->
        <div class="metric-sub">
...
<footer>
  <div class="footer-brand">
    ...
    <span class="footer-rights">&copy; 2024 WebName Ltd.<br/>All rights reserved.</span>
  </div>
